...
# LOAD AND CLEAN DATA
def load_mimic3_data(mimic_3data):
    ...
    note_events = pd.read_csv(os.path.join(mimic_3data, "NOTEVENTS.csv.gz"), compression="gzip")
...
if __name__ == "__main__":
    ...
    full_data = load_mimic3_data(mimic_data)
