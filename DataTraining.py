...
for run in range(1, NUM_RUNS + 1):
    ...
    epoch_losses = train_model(model, loader, epochs=10)
...
epoch_df.to_excel("mimic3_epoch_losses.xlsx", index=False)
print("Epoch losses saved to mimic3_epoch_losses.xlsx")
